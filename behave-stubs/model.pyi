...
class Feature(TagAndStatusStatement, Replayable):
    ...
    parser: Incomplete
    hook_failed: bool
    def __init__(self, filename, line, keyword, name, tags: Incomplete | None = None, description: Incomplete | None = None, scenarios: Incomplete | None = None, background: Incomplete | None = None, language: Incomplete | None = None) -> None: ...
    def reset(self) -> None: ...
    def __iter__(self): ...
    ...
    def skip(self, reason: Incomplete | None = None, require_not_executed: bool = False) -> None: ...
    def run(self, runner): ...
...
class Scenario(TagAndStatusStatement, Replayable):
    ...
    hook_failed: bool
    was_dry_run: bool
    def __init__(self, filename, line, keyword, name, tags: Incomplete | None = None, steps: Incomplete | None = None, description: Incomplete | None = None) -> None: ...
    def reset(self) -> None: ...
    @property
...
class ScenarioOutline(Scenario):
    ...
    examples: Incomplete
    def __init__(self, filename, line, keyword, name, tags: Incomplete | None = None, steps: Incomplete | None = None, examples: Incomplete | None = None, description: Incomplete | None = None) -> None: ...
    def reset(self) -> None: ...
    @property
    def scenarios(self): ...
    def __iter__(self): ...
...
class Examples(TagStatement, Replayable):
    ...
    table: Incomplete
    index: Incomplete
    def __init__(self, filename, line, keyword, name, tags: Incomplete | None = None, table: Incomplete | None = None) -> None: ...
...
class Step(BasicStatement, Replayable):
    ...
    hook_failed: bool
    duration: int
    def __init__(self, filename, line, keyword, step_type, name, text: Incomplete | None = None, table: Incomplete | None = None) -> None: ...
    def reset(self) -> None: ...
...
class Table(Replayable):
    ...
    line: Incomplete
    rows: Incomplete
    def __init__(self, headings, line: Incomplete | None = None, rows: Incomplete | None = None) -> None: ...
    def add_row(self, row, line: Incomplete | None = None) -> None: ...
    def add_column(self, column_name, values: Incomplete | None = None, default_value: str = ''): ...
...
class Row:
    ...
    cells: Incomplete
    line: Incomplete
    def __init__(self, headings, cells, line: Incomplete | None = None, comments: Incomplete | None = None) -> None: ...
