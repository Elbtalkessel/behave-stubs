...
class ParserError(Exception):
    ...
    filename: Incomplete
    def __init__(self, message, line, filename: Incomplete | None = None, line_text: Incomplete | None = None) -> None: ...
...
class Parser:
    ...
    examples: Incomplete
    keywords: Incomplete
    def __init__(self, language: Incomplete | None = None, variant: Incomplete | None = None) -> None: ...
    def reset(self) -> None: ...
