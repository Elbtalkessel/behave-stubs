...
class FeatureScenarioLocationCollector:
    ...
    def __init__(self, feature: Incomplete | None = None, location: Incomplete | None = None, filename: Incomplete | None = None) -> None: ...
    def clear(self) -> None: ...
...
def exec_file(filename, globals_: Incomplete | None = None, locals_: Incomplete | None = None) -> None: ...
...
def print_undefined_step_snippets(undefined_steps, stream: Incomplete | None = None, colored: bool = True) -> None: ...
