...
class ActiveTagMatcher(TagMatcher):
    ...
    def __init__(self, value_provider, tag_prefixes: Incomplete | None = None, value_separator: Incomplete | None = None, ignore_unknown_categories: Incomplete | None = None) -> None: ...
    @classmethod
    def make_tag_pattern(cls, tag_prefixes, value_separator: Incomplete | None = None): ...
    @classmethod
    def make_category_tag(cls, category, value: Incomplete | None = None, tag_prefix: Incomplete | None = None, value_sep: Incomplete | None = None): ...
    def is_tag_negated(self, tag): ...
    def is_tag_group_enabled(self, group_category, group_tag_pairs): ...
    def should_exclude_with(self, tags): ...
    def select_active_tags(self, tags) -> Generator[Incomplete]: ...
    def group_active_tags_by_category(self, tags) -> Generator[Incomplete]: ...
...
class OnlyWithCategoryTagMatcher(TagMatcher):
    ...
    def __init__(self, category, value, tag_prefix: Incomplete | None = None, value_sep: Incomplete | None = None) -> None: ...
    def should_exclude_with(self, tags): ...
...
class OnlyWithAnyCategoryTagMatcher(TagMatcher):
    ...
    def __init__(self, value_provider, tag_prefix: Incomplete | None = None, value_sep: Incomplete | None = None) -> None: ...
    def should_exclude_with(self, tags): ...
    def select_category_tags(self, tags): ...
