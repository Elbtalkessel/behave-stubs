...
class Captured:
    ...
    def __init__(self, stdout: Incomplete | None = None, stderr: Incomplete | None = None, log_output: Incomplete | None = None) -> None: ...
    def reset(self) -> None: ...
...
def capture_output(controller, enabled: bool = True) -> Generator[None]: ...
