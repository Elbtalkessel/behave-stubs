...
def config_filenames() -> Generator[Incomplete]: ...
...
class Configuration:
    ...
    stage: Incomplete
    stderr_capture: bool
    def __init__(self, command_args: Incomplete | None = None, load_config: bool = True, verbose: Incomplete | None = None, **kwargs) -> None: ...
    ...
    def setup_logging(self, level: Incomplete | None = None, configfile: Incomplete | None = None, **kwargs) -> None: ...
